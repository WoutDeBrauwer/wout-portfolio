  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="flex-1 flex items-stretch justify-center relative z-10">
        <div className="max-w-[1600px] w-full flex flex-col lg:flex-row mx-auto">
          {/* Linkerzijde: zwart */}
          <div className="flex-1 flex items-start bg-transparent py-20">
            <div className="max-w-[800px] w-full px-10 text-white">
